...
//______________
		...
		$stmt->bindValue(':data', $this->tarefa->__get('data'));//novo
	...
	public function atualizar() { //update
		...
		$stmt->bindValue(1, $this->tarefa->__get('data'));//novo
		$stmt->bindValue(2, $this->tarefa->__get('abertura'));//novo
		$stmt->bindValue(3, $this->tarefa->__get('intervalo'));//novo
		$stmt->bindValue(4, $this->tarefa->__get('fechamento'));//novo
		$stmt->bindValue(5, $this->tarefa->__get('nome'));//novo
